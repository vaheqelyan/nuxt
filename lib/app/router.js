...
export function createRouter (context) {
  ...
  if (context && context.beforeRenderFns) {
    base = context.req.headers['x-vue-router-base']

    context.beforeRenderFns.push(({ nuxtState }) => {
      nuxtState.vueRouterBase = base
    })
  } else {
    base = __NUXT__.vueRouterBase
  }

  return new Router({
    mode: '<%= router.mode %>',
    base: base || '<%= router.base %>',
